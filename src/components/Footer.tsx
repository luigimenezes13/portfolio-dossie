  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-neutral-300 font-normal">
        ...
        <div className="flex items-center gap-6">
          <span className={`hover:text-neutral-200 transition-colors duration-300 ${TYPOGRAPHY.bodySmall}`}>Atualizado: {new Date('05-10-2025').toLocaleDateString('pt-BR')}</span>
          <span>•</span>
