  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className={`group relative ${CARD_CLASSES.base} hover:shadow-xl hover:shadow-primary/20 hover:border-primary/30`}>
          ...
          <div className="flex items-center gap-3 mb-4 pb-3 border-b border-white/10">
            <div className="p-2.5 bg-primary/10 border border-primary/30 rounded-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 group-hover:bg-primary/20">
              <Briefcase className={`w-5 h-5 ${ICON_COLORS.primary} group-hover:text-primary`} />
            </div>
        ...
        <div className={`group relative ${CARD_CLASSES.base} hover:shadow-xl hover:shadow-tertiary/20 hover:border-tertiary/30`}>
          {/* Ícone */}
          <div className="flex items-center gap-3 mb-4 pb-3 border-b border-white/10">
            <div className="p-2.5 bg-tertiary/10 border border-tertiary/30 rounded-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 group-hover:bg-tertiary/20">
              <FileText className={`w-5 h-5 ${ICON_COLORS.tertiary} group-hover:text-tertiary`} />
            </div>
        ...
        {/* Card: Empresa */}
        <div className={`group relative ${CARD_CLASSES.base} hover:shadow-xl hover:shadow-secondary/20 hover:border-secondary/30`}>
          {/* Ícone */}
          <div className="flex items-center gap-3 mb-4 pb-3 border-b border-white/10">
            <div className="p-2.5 bg-secondary/10 border border-secondary/30 rounded-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 group-hover:bg-secondary/20">
              <Building2 className={`w-5 h-5 ${ICON_COLORS.secondary} group-hover:text-secondary`} />
            </div>
