...
export function ObjetivoSection({ objetivo }: ObjetivoSectionProps) {
  return (
    <section className="bg-gradient-to-br from-secondary/30 to-black border border-tertiary/20 rounded-2xl p-8 animate-fade-in-up hover:shadow-xl hover:shadow-primary/10 transition-all duration-300" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
