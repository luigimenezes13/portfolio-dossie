  ...
  return (
    ...
    >
      <div className="section-header">
        ...
        <div>
          <h2 className={TYPOGRAPHY.sectionTitlePrimary}>Potencial de Retorno</h2>
      ...
      <div className="mb-12">
        ...
        <div className="grid gap-4">
          {potencialRetorno.beneficios.map((beneficio, idx) => (
            ...
            >
              <CheckCircle2 className={`w-6 h-6 ${ICON_COLORS.secondary} group-hover:text-secondary/80 flex-shrink-0 group-hover:scale-110 transition-all duration-300 mt-0.5`} />
              <span className={`${TYPOGRAPHY.body} group-hover:text-white transition-colors duration-300`}>
                {beneficio}
              </span>
            </div>
          ))}
      ...
      {(potencialRetorno.projecaoCargo || potencialRetorno.prazoEvolucao || potencialRetorno.estimativaROI) && (
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-6">
            <LineChart className={`w-5 h-5 ${ICON_COLORS.primary}`} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-neutral-800/30 to-neutral-900/20 border border-primary/30 hover:border-primary/50 p-6 transition-all duration-500 hover:scale-[1.02] hover:shadow-lg hover:shadow-primary/20`}>
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <Crosshair className={`w-8 h-8 ${ICON_COLORS.primary} group-hover:text-primary/80 group-hover:rotate-12 transition-all duration-500`} />
            ...
            {potencialRetorno.prazoEvolucao && (
              <div className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br from-tertiary/10 via-neutral-800/30 to-neutral-900/20 border border-tertiary/30 hover:border-tertiary/50 p-6 transition-all duration-500 hover:scale-[1.02] hover:shadow-lg hover:shadow-tertiary/20`}>
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <Clock className={`w-8 h-8 ${ICON_COLORS.tertiary} group-hover:text-tertiary/80 group-hover:rotate-12 transition-all duration-500`} />
            ...
            {potencialRetorno.estimativaROI && (
              <div className={`group relative overflow-hidden ${CARD_CLASSES.base} hover:border-secondary/40 p-6 transition-all duration-500 hover:scale-[1.02] hover:shadow-lg hover:shadow-secondary/10`}>
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <TrendingUp className={`w-8 h-8 ${ICON_COLORS.neutral} group-hover:text-secondary group-hover:scale-110 transition-all duration-500`} />
